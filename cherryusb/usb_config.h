...
#define CONFIG_USB_DBG_LEVEL USB_DBG_ERROR//USB_DBG_LOG
#endif
...
#define USB_NOCACHE_RAM_SECTION __attribute__((section("NO_INIT")))
...
#define CONFIG_USBHOST_MAX_INTERFACES       20//8
#define CONFIG_USBHOST_MAX_INTF_ALTSETTINGS 20//8
...
#define CONFIG_USBHOST_PSC_PRIO 0              // 优先级 0 --> 10
#endif
...
#define CONFIG_USBHOST_CONTROL_TRANSFER_TIMEOUT 0xffffffff//500
#endif
